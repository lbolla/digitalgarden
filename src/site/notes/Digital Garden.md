...
I then installed the [Obsidian's Digital Garden](https://github.com/oleeskild/obsidian-digital-garden) plugin and configured to publish the notes to [[Netlify\|Netlify]].
...
- [[Netlify\|Netlify]] triggers a deployment of the notes, which are published in a few seconds
## Next steps
