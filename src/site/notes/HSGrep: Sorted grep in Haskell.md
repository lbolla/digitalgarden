...
Thanks a lot for [all your useful suggestions](http://codereview.stackexchange.com/q/6318/8638)! As soon as possible, I\'ll post some benchmarking [here](./hsgrep-benchmarking). (EDIT: [benchmarks now available!](./hsgrep-benchmarking.org))
